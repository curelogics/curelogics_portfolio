    ...
    useEffect(() => {
        const fetchBlogs = async () => {
            try {
                ...
                if (result.success) {
                    // Sort blogs by clickCount in descending order
                    const sortedBlogs = result.data.sort((a, b) => (b.clickCount || 0) - (a.clickCount || 0));
            ...
            <div className="container mx-auto px-4 relative z-10">
                ...
                <div className="text-center mb-16 relative">
                    ...
                    <p className="text-xl lg:text-2xl text-gray-700 max-w-3xl mx-auto leading-relaxed font-medium">
                        Discover all our insights and stories
                        <span className="bg-gradient-to-r from-red-600 to-blue-900 bg-clip-text text-transparent font-semibold">
                            {" "}
